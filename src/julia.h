...
// compiler
DLLEXPORT void jl_compile(jl_function_t *f);
DLLEXPORT void jl_compile_hint(jl_function_t *f, jl_tuple_t *types);
DLLEXPORT jl_function_t *jl_get_specialization(jl_function_t *f, jl_tuple_t *types);
...
#include<pthread.h>
extern DLLEXPORT pthread_mutex_t jl_lock;
